<?php $this->layout("_theme", ['title' => 'Registre-se']); ?>
    ...
    <div class="container">
        ...
        <div class="toast text-white bg-dark border-0 my-5 position-absolute" data-bs-autohide="true" role="alert"
            ...
            <div class="toast-body">
                <i class="bi bi-exclamation-triangle-fill"></i> <?= $erroMsg ?>
            </div>
        </div>
        <?php endif; ?>
        <div class="row">
            <div class="col-sm-12 col-md-6 offset-md-3 col-lg-4 offset-lg-4 my-5 rounded">
                ...
                <form action="register_action" method="POST">
                    ...
                    <div class="mb-5 d-grid gap-2">
                        <button type="submit" class="btn btn-outline-primary">Registrar-se</button>
                    </div>
                </form>
                <div class="mb-3">
                    <div class="row">
                        <div class="col-6">
                            <a href="<?= url() ?>" class="btn btn-outline-dark">Voltar</a>
                        </div>
